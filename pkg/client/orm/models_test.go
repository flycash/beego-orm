...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/flycash/beego-orm/pkg/client/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/flycash/beego-orm/pkg/client/orm.GroupPermissions)"`
}
...
var (
	...
	go get -u github.com/flycash/beego-orm/pkg/client/orm
	...
	go test -v github.com/flycash/beego-orm/pkg/client/orm
	...
	go test -v github.com/flycash/beego-orm/pgk/orm
